"""IAMLINT core — Lint cloud IAM policies (AWS/GCP/Azure JSON) for least-privilege violations."""
...
RULES = [
    ("IAM-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("IAM-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("IAM-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
