"""IAMLINT command-line interface."""
from __future__ import annotations
import argparse, sys
from iamlint.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="iamlint", description="IAMLINT — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from iamlint.mcp_server import serve
        return serve()
    if args.cmd == "scan":
