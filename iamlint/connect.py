"""Native cognis-connect emit for iamlint — forward findings to any platform.

Maps iamlint's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    iamlint ... --format json | iamlint-emit --to stix
    iamlint-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
