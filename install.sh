#!/usr/bin/env sh
# Universal installer for iamlint. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/iamlint.git"
echo "Installing iamlint ..."
